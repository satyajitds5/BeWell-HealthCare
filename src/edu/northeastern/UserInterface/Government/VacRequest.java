...
//        Time();
    ...
    private void approveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_approveButtonActionPerformed
        ...
        ArrayList<edu.northeastern.Business.WorkQueue.VacRequest> vaccines =vacReqDir.getRequests();
        int size = vaccines.size();
        for(int i=0;i<size;i++)
        {
            edu.northeastern.Business.WorkQueue.VacRequest vaccine = vaccines.get(i);
    ...
    private void cancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelButtonActionPerformed
        ...
        VacRequest_Dir vacReqDir = system.getVaccReqDir();
        ArrayList<edu.northeastern.Business.WorkQueue.VacRequest> requests= vacReqDir.getRequests();
        int size = requests.size();
        for(int i=0;i<size;i++)
        {
            edu.northeastern.Business.WorkQueue.VacRequest request = requests.get(i);
